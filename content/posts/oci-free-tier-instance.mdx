...
- <strong>7일 만에 크리스마스 선물로 성공! 🎄</strong>
</Callout>
...
ARM 기반이긴 하지만, 이 스펙이 <strong>영구 무료</strong>라고?
...
<strong>교훈: OCID는 반드시 콘솔에서 직접 복사하자.</strong>
...
- <strong>cron 최소 간격이 5분</strong>: 경쟁이 치열한 상황에서 불리

- <strong>실행 지연/누락 빈번</strong>: 실제로는 7분~30분에 한 번 실행되기도 함
...
<strong>12월 25일 오후 2시 4분 (KST)</strong>, 크리스마스 당일에 Discord 알림이 울렸다.
...
| Azure VM 크론잡 | 2분 (안정) | ✅ <strong>성공</strong> |
