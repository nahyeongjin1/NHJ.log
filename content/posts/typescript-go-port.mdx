...
updatedAt: '2026-01-05T09:42:00.000Z'
...
<LinkCard url="https://github.com/microsoft/TypeScript" title="GitHub - microsoft/TypeScript: TypeScript is a superset of JavaScript that compiles to clean JavaScript output." description="TypeScript is a superset of JavaScript that compiles to clean JavaScript output. - microsoft/TypeScript" image="https://opengraph.githubassets.com/031da8ff0d7d4418d6bdeed9b66242a8420db78da173636e709cbe37f1b4261b/microsoft/TypeScript" favicon="https://github.githubassets.com/favicons/favicon.svg" />
...
에디터 로드 시간도 마찬가지다. VS Code 프로젝트 기준으로 9.6초에서 1.2초로, 약 8배 빨라진다.
